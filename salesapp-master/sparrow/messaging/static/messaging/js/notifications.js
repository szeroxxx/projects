function notificationsInit() {
    ...
    sparrow.registerCtrl('notificationsCtrl',function($scope, $rootScope, $route, $compile, DTOptionsBuilder, DTColumnBuilder, $templateCache){        
        ...
        sparrow.post("/messaging/notifications/", {count : 0}, false, function(data) {
        ...
        function selectdMarkRead(post_ids) {
            ...
            sparrow.post("/messaging/mark_as_read/", {ids: ids}, false, function(data) {
                if(data.code==1){
                    $route.reload();
                }
        ...
        $scope.markAsRead = function(is_user_notifications) {
            sparrow.post("/messaging/mark_as_all_read/", {is_user_notifications: is_user_notifications}, false, function(data) {
                if(data.code==1){
        ...
        $scope.viewMoreUser = function(event) {
            ...
            sparrow.post("/messaging/notifications/", {count : count}, false, function(data) {
