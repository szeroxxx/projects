...
class ProfileForm(forms.Form):
    ...
    default_page = forms.CharField(label='Default page', max_length=250, required = False, help_text="This will be your default page after login. Input page URL from address bar for the page you want to load. (e.g. http://servername/b/#/purchasing/dashboard/)")
    ...
    def clean_avatar(self):
        ...
        try:
            ...
            if len(avatar) > (1000 * 1024):
                raise forms.ValidationError(u'Avatar file size may not exceed 1024k.')
            return avatar
...
class PasswrecoveryForm(forms.Form):
    email = forms.EmailField(label='Enter your email address and we will send you a link to reset your password.', required=True, max_length=200)
