    ...
    sparrow.registerCtrl('moInventoryCtrl', function ($scope, $rootScope, $route, $routeParams, $compile, DTOptionsBuilder, DTColumnBuilder, $templateCache, ModalService) {
            ...
            listing: [
                {
                    ...
                    columns: [
                        ...
                        { name: 'remarks', title: 'External Document Nr', sort: false },
        ...
        function dtBindFunction() {
            ...
            if (Dates != '') {
                ...
                if (parseInt(newToDate[0]) < 31) {
                    newToDate[0] = parseInt(newToDate[0]).toString();
                    to_date = newToDate.join('/').trim();
                }
            }

            var MO_status_value = $('#MO_status_value').val();
            var postData = {
                from_date: from_date,
                to_date: to_date,
                MO_status_value: MO_status_value,
            };
        ...
        function onExport(scope) {
            ...
            var url = '/base/mo_inventory_export?from=' + postData['from_date'] + '&to=' + postData['to_date'] + '&MO_status_value=' + postData['MO_status_value'];
