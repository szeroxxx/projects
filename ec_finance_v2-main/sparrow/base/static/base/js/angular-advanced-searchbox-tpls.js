                            ...
                            function (newValue, oldValue) {
                                ...
                                angular.forEach($scope.model, function (value, key) {
                                    if (key === 'query' && $scope.searchQuery !== value) {
                                        ...
                                        var paramTemplate = $filter('filter')($scope.filterParameter, function (param) {
     ...
     */
        $templateCache.put(
            ...
            '<div class=advancedSearchBox ng-class={active:focus} ng-init="focus = false" ng-click="!focus ? setSearchFocus = true : null">' +
                ...
                '<ul id = "dropdownMenuRight" class="dropdown-menu dropdown-menu-org dropdown-menu-right" style="width:220px !important">' +
