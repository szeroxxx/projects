...
(function () {
    angular.module('angular-subscriptions', []).directive('angSubscriptions', function () {
        return {
            restrict: 'AEC',
            scope: {
                appName: '@',
...
angular.module('angular-subscriptions').run([
    '$templateCache',
    function ($templateCache) {
        'use strict';
        $templateCache.put(
            'angular-subscriptions.html',
