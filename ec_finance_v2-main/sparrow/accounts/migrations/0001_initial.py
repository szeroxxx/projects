# Generated by Django 2.2.6 on 2023-05-30 11:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_code', models.IntegerField(blank=True, help_text='Specify company code if this menu is specific to company', null=True, verbose_name='Company Code')),
                ('menu_code', models.CharField(blank=True, max_length=200, null=True, verbose_name='Menu Code')),
                ('launcher_add_url', models.CharField(blank=True, max_length=1000, null=True, verbose_name='Launcher Add New Url')),
                ('launcher_menu', models.BooleanField(default=False, verbose_name='Launcher menu')),
                ('launcher_sequence', models.IntegerField(blank=True, default=0, help_text='Specify the order of menu icons.', null=True, verbose_name='Launcher Sequence')),
                ('is_operator', models.BooleanField(default=False, verbose_name='View operator')),
                ('is_customer_user', models.BooleanField(default=False, verbose_name='View customer user')),
