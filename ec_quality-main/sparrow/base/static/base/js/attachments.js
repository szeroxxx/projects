    ...
    .directive("angAttachments", function () {
      return {
        ...
        link: function ($scope, elem, attrs, Upload) {
          ...
          $scope.editDocument = function (e, doc_id) {
            permission = $scope.permissions;
                    ...
                    <div ng-show="IsVisible" >\
                        <div class="col-sm-12" style="margin-top:8px;" >\
                            <div class="col-sm-7" style="padding-left:15px; display:flex;">\
                                ...
                                <img class="attachmentPropertyImage" ng-src="{[{getPreviewImage(attachment_name)}]}" class="image-attachment" ng-class="{\'no-image\':!isImage(getFileExtension(attachment_name)), \'image-file-background\':isImage(getFileExtension(attachment_name))}">\
                                  <b style="margin-left:10px;font-size: 17px;word-break: break-all">{[{attachment_name}]}</b>\
                                </span>\
                                <span style="margin-left:10px;font-color:#656565" ng-if="attachment_data.is_public" class="icon-users"></span>\
                            </div>\
                            <div class="col-sm-5">\
                              <div ng-if="attachment_data.req_user == \'true\'" id="id_staff_file_dlt">\
                                <i style="float:right;margin-right:3px;" class="icon-trash list-btn fa fa-trash-o fa-bold" ng-click="delete(attachment_data);$event.stopPropagation();" title="Delete document" ref="{[{attachment_data.uid}]}" ></i>\
                              </div>\
                              <div ng-if="attachment_data.req_user == \'true\'" id="id_staff_file_dlt">\
                              <a ng-if="getFileExtension(attachment_data.name) == \'html\'">\
                                <i style="float:right;margin-right:3px;" class="icon-pencil-1 list-btn editIcon" ng-click="editDocument($event,attachment_data.id)" title="Edit document"></i>\
                              </a>\
                            </div>\
                              <a style="float:right;margin-top:6px;"  ng-click="childClick();$event.stopPropagation();" href="/attachment/dwn_attachment/?uid={[{attachment_data.uid}]}&a={[{attachment_data.app_name}]}&m={[{attachment_data.model_name}]}" title="Download document" target="_blank">\
                              ...
                              <div class="attachmentLockUnlock">\
                                <div id="id_staff_file_lock">\
                                  ...
                                  <i  style="color:red;;float:right;margin-right:5px" ng-if="!attachment_data.is_public  && attachment_data.req_user == \'true\'" ng-click="toggleAccess(attachment_data)" title="Make document public"  class="icon-lock fa fa-lock att-lock " /></a>\
                                  <i  style="padding-left:2px;" ng-if="attachment_data.is_public" ng-click="copyLink(attachment_data.uid,attachment_data.app_name,attachment_data.model_name)" title="Copy public URL" class="icon-file-copy fa fa-copy att-lock " />\
                              </div>\
                            </div>\
                        </div>\
