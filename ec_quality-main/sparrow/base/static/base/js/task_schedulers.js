function taskSchedularsInit() {
    ...
    sparrow.registerCtrl('taskSchedulersCtrl', function ($scope, $rootScope, $route, $compile, DTOptionsBuilder, DTColumnBuilder, $templateCache, ModalService) {
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            renderWith: function (data, type, full, meta) {
                                ...
                                return (
                                    '<i class="icon-arrow-2-circle-right pending" style="' +
                                    pendingStatus +
                                    '" id="run_' +
                                    full.id +
                                    ...
                                    '\')"></i><img style="' +
                                    runningStatus +
                                    '" class="process" id="process_' +
                                    full.id +
                                    '"  title="processing" src="/static/base/images/spinner.gif">'
                                );
                            },
                        },
                    ],
        ...
        function setData(data) {
            ...
            $('input[type=checkbox][name=is_running]').prop('checked', data.is_running);
