...
from qualityapp.models import ActiveOperators, Company, CompanyUser, Operator, OperatorLogs
from sqlalchemy import null
from qualityapp.views import skill_data_auto_assign_to_login
...
def signin(request):
    ...
    return render(request, "accounts/signin.html",{"company_logo": company_logo_, "crousel_image": crousel_data})
