...
class Attachment(models.Model):
    ...
    url = models.FileField(upload_to=update_filename, max_length=270)
    ...
    def get_file_rootpath(rootFolderName):
        path = "public" + "\\{}\\{}\\{}\\{}\\".format(rootFolderName, str(datetime.date.today().year), str(datetime.date.today().month), str(datetime.date.today().day))
        return path
