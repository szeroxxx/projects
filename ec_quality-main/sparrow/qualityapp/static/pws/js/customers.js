  ...
  sparrow.registerCtrl(
    ...
    function (
      ...
      var config = {
        ...
        topActionbar: {
          add: {
            url: "/#/qualityapp/customer/",
          },
          delete: {
            url: "/qualityapp/delete_customer/",
          },
          edit: {
            url: "/#/qualityapp/customer/",
          },
        ...
        listing: [
          {
            ...
            url: "/qualityapp/search_customer/",
            crud: true,
            scrollBody: true,
            columns: [
              {
        ...
        sparrow.postForm(
          ...
          function (data) {
            if(data.id != null){
              ...
              window.location.href = "#/qualityapp/place_order/" + rowData[0].id + "/" + customerUserId + "/";
            }
          }
        );
      };
      ...
      function onExport() {
        ...
        sparrow.downloadData("/qualityapp/exports_customer/", {
          ids: selectedIds,
          customer: customer,
          gen_mail: gen_mail,
      ...
      $scope.onEditCustomer = function (id) {
        window.location.href = "#/qualityapp/customer/" + id + "/";
      };
      ...
      function setOrderScreen() {
        ...
        sparrow.post(
          "/qualityapp/set_order_screen/" + rowData[0].id + "/",
          {},
          false,
          function (data) {
        ...
        sparrow.postForm(
          ...
          function (data) {
            if (data.code == 1) {
              ...
              window.location.hash = "#/qualityapp/customers/";
            }
          }
        );
      };
      ...
      $scope.setScreenData = function () {
        ...
        if(comp_id.length !=0){
          ...
          $("#setScreenTitle").text("Set order screen ( " + rowData[0].name + " )");
          sparrow.post(
            "/qualityapp/set_order_screen_copy/" + company_id + "/",
            {
