    ...
    function (
      ...
      var searchObj = {
          params: [
            ...
            { key: "ecc_status", name: "qualityapp status" },
        ...
        listing: [
          {
            ...
            url: "/qualityapp/compare_orders_search/ec_pending/0/"+$scope.requestStatus["ec_pending"]+"/",
            crud: true,
            columns:columnObj,
          },
          {
            index: 2,
            search:searchObjByOrderNr,
            url: "/qualityapp/compare_orders_search/ec_inq_pending/0/"+$scope.requestStatus["ec_inq_pending"]+"/",
            crud: true,
            columns:columnObj,
          },
          {
            index: 3,
            search:searchObjByOrderNr,
            url: "/qualityapp/compare_orders_search/power_pending/0/"+$scope.requestStatus["power_pending"]+"/",
            crud: true,
          ...
          },
          {
            index: 4,
            search:searchObjByOrderNr,
            url: "/qualityapp/compare_orders_search/power_inq_pending/0/"+$scope.requestStatus["power_inq_pending"]+"/",
            crud: true,
            columns:columnObjPower,
          },
          {
           index: 5,
           search:searchObj,
           url: "/qualityapp/compare_orders_search/imported/0/"+$scope.requestStatus["imported"]+"/",
           crud: true,
           columns:columnObjqualityapp,
         },
          {
           index: 6,
           search:searchObjByOrderNr,
           url: "/qualityapp/compare_orders_search/ec_compare/0/"+$scope.requestStatus["ec_compare"]+"/",
           crud: true,
         ...
         },
          {
           index: 7,
           search:searchObjByOrderNr,
           url: "/qualityapp/compare_orders_search/power_compare/0/"+$scope.requestStatus["power_compare"]+"/",
           crud: true,
      ...
      $scope.onTabChange = function (status, index) {
        ...
        if ($scope.requestStatus[status] == false) {
          config.listing[index - 1].url =
            "/qualityapp/compare_orders_search/" + status + "/0/true/";
