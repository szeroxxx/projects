    ...
    function (
      ...
      var config = {
        ...
        listing: [
          {
            index: 1,
            url: "/qualityapp/search_work_details_reports/",
            paging: true,
            scrollBody: true,
            on_load: false,
            crud: true,
      ...
      $scope.onExport = function () {
        ...
        sparrow.downloadData("/qualityapp/work_details_reports_export/", {
      ...
      $scope.viewOrderDetails = function (order_id, customer_order_nr) {
        remarks_ = false
        $scope.onEditLink('/b/iframe_index/#/qualityapp/order/' + order_id  + remarks_, 'Order - ' + customer_order_nr, closeIframeCallback, '', '', true);
      };
