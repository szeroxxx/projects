  ...
  sparrow.registerCtrl(
    ...
    function (
        ...
        listing: [
          {
            ...
            crud: false,
            url: "/qualityapp/search_engineers_work_report/",
            columns: [
              {
                name: "company__name",
                title: "Company",
      ...
      function loadEngineerWorkReport(company_id, select_id, service_id) {
        sparrow.post(
          "/qualityapp/engineers_work_report_process_count/",
          {
      ...
      $("#btnExport").on("click", function () {
        ...
        sparrow.downloadData("/qualityapp/exports_engineers_work_report/", {
