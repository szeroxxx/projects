  ...
  sparrow.registerCtrl(
    ...
    function (
        ...
        listing: [
          {
            ...
            search: searchObj,
            url:
              "/qualityapp/exceptions_search/in_coming/0/" +
          ...
          },
          {
            ...
            search: searchObj,
            url:
              "/qualityapp/exceptions_search/put_to_customer/0/" +
      ...
      $scope.onTabChange = function (status, index) {
        ...
        if ($scope.requestStatus[status] == false) {
          config.listing[index - 1].url =
            "/qualityapp/exceptions_search/" + status + "/0/true/";
                        ...
                        function(data){
                          if(data.code == 1){
                                ...
                                sparrow.showMailScreen(ModalService,
                                  ...
                                  attachments,
                                  rowData[0].order__id,
                                  "/qualityapp/send_exception_mail/",
                                  to_emails,
                                  cc_mails,
                                  emailTeplate,
                                  "",
      ...
      function onExport() {
        ...
        sparrow.downloadData("/qualityapp/exports_exception/", {
      ...
      $scope.viewOrderDetails = function (order__id, order__customer_order_nr) {
        remarks_ = false
        $scope.onEditLink(
          "/b/iframe_index/#/qualityapp/order/" + order__id  + remarks_,
          ...
          if (data.permissions['cancel_order_exception'] == false) {
              ...
              sparrow.showConfirmDialog(
                ...
                function (confirm) {
                  if (confirm) {
                    sparrow.post(
                      "/qualityapp/exception_order_cancel/" + rowData[0].order__id + "/",
                      {
