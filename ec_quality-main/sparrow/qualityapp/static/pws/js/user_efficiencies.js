  ...
  sparrow.registerCtrl(
    ...
    function (
      ...
      var config = {
        ...
        topActionbar: {
          delete: {
            url: "/qualityapp/user_efficiencies_delete/",
          },
          extra: [
            {
              id: "btnEdit",
        ...
        listing: [
          {
            ...
            crud: true,
            scrollBody: true,
            url: "/qualityapp/user_efficiencies_search/",
            columns: [
              {
                name: "company__name",
                title: "Customer",
      ...
      function onExport() {
        ...
        sparrow.downloadData("/qualityapp/exports_user_efficiencies/", {
          ids: selectedIds,
          company: company,
          service: service,
          process: process,
