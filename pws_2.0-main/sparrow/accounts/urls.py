...
urlpatterns = [
    ...
    url(r"^sparrow_setup/$", views.sparrow_setup, name="sparrow_setup"),
    ...
    url(r"^submit_sparrow_issue/$", views.submit_sparrow_issue, name="submit_sparrow_issue"),
    url(r"^notification_delete/$", views.notification_delete, name="notification_delete"),
    url(r"^customer_registration", views.customer_registration, name="customer_registration"),
    url(r"^whitelist_ips/$", views.whitelist_ips, name="whitelist_ips"),
    url(r"^save_whitelist_ip/$", views.save_whitelist_ip, name="save_whitelist_ip"),
    url(r"^customer_masters/$", views.customer_masters, name="customer_masters"),
    url(r"^customer_masters_search/$", views.customer_masters_search, name="customer_masters_search"),
]
