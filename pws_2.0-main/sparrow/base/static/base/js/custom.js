...
$(document).ready(function () {
    ...
    var setContentHeight = function () {
        ...
        if ($('.scroll-body').length > 0) {
            var height = $(window).height() - ($('.nav_menu').outerHeight() + 225);
    ...
    $SIDEBAR_MENU.find('a').on('click', function (ev) {
        ...
        if ($li.is('.active')) {
            ...
            if (!$li.parent().is('.child_menu')) {
                $SIDEBAR_MENU.find('li').removeClass('active').removeClass('current-page');
    ...
    if (defaultView == 'icon_only') {
        $('.toggle_menu').hide();
        $(".footer-text").attr("style", "margin-left: 0%;");
    ...
    if (defaultView == 'icon_with_textwith_text') {
        $('.toggle_menu').show();
        $(".footer-text").attr("style", "margin-left: 11%;");
