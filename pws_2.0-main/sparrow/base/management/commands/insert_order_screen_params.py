...
from pws.models import (Efficiency, NonConformity, NonConformityDetail,
            ...
            with transaction.atomic():
                ...
                def update_order_pws_id():
                    ...
                    while True:
                        ...
                        elapsed_time_secs = time.time() - start_time
                        print("==> Update order pws id(" + str(start) + " to " + str(start + length) + ") Total Execution time: %s" % timedelta(seconds=round(elapsed_time_secs)))
                        start += length
