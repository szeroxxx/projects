  ...
  sparrow.registerCtrl(
    ...
    function (
      ...
      var config = {
        ...
        topActionbar: {
          add: { url: "/#/pws/customer_user/" },
          delete: { url: "/pws/delete_customer_user/" },
          edit: { url: "/#/pws/customer_user/" },
          extra: [
            {
              id: "btnExport",
              function: onExport,
      ...
      function onExport() {
        ...
        sparrow.downloadData("/pws/exports_customer_user/", {
          ids: selectedIds,
          username: username,
      ...
      $scope.onEditCustomerUser = function (id) {
        window.location.href = '#/pws/customer_user/' + id + '/';
      };
      sparrow.setup(
        $scope,
        $rootScope,
