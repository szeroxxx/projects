  ...
  sparrow.registerCtrl(
    ...
    function (
      ...
      function onSkillMatrix() {
        ...
        window.location.hash = "#/pws/skill_matrix/";
      };
      ...
      sparrow.showConfirmDialog(ModalService, "Are you sure you want to remove?", "Remove auto allocation",
          function (confirm) {
            if (confirm) {
              sparrow.post(
                "/pws/remove_manage_auto_allocation_data/",
                {
    ...
    $scope.closeReserveMultipleModel = function(){
      ...
      function AutoAssignment(scope) {
        ...
        sparrow.post("/pws/auto_assignment/", data, $scope,);
        $scope.reloadData(1);
      }
            ...
            function dtBindFunction() {
                ...
                if (company_id != ""){
                  ...
                  sparrow.post(
                    "/pws/show_auto_define_assignment_flow/",
            ...
            $scope.saveAllocationFlow = function (event) {
              ...
              sparrow.post(
                "/pws/auto_define_assignment_flow/",
              postData,
              false,
              function (data) {
                if (data.code == 1) {
      ...
      function onExport() {
        ...
        sparrow.downloadData("/pws/exports_order_allocations/", {
