  ...
  sparrow.registerCtrl(
    ...
    function (
      ...
      var config = {
        pageTitle: "Operators",
        topActionbar: {
          add: { url: "/#/pws/operator/" },
          edit: { url: "/#/pws/operator/" },
          delete: { url: "/pws/delete_operators/" },
          extra: [
            {
              id: "btnExport",
              function: onExport,
      ...
      function onExport() {
        ...
        sparrow.downloadData("/pws/exports_operators/", {
          ids: selectedIds,
          username: username,
      ...
      $scope.onEditOperator = function (id) {
        window.location.href = '#/pws/operator/' + id + '/';
      };
