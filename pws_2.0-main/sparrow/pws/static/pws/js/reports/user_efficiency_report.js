  ...
  sparrow.registerCtrl(
    ...
    function (
        ...
        listing: [
          {
            ...
            crud: false,
            url: "/pws/search_user_efficiency_reports/",
            columns: [
              {
              ...
              {
                name: "operator__sub_group_of_operator__sub_group_name",
                title: "Sub group",
              },
              {
                name: "pi",
      ...
      $("#saveChanges").on("click", function () {
        ...
        sparrow.post(
          "/pws/update_user_efficiency_report/",
          {
      ...
      $scope.viewOrderDetails = function (operator_id, select_date, operator_name) {
        $scope.onEditLink('/b/iframe_index/#/pws/user_efficiency_add_remark/' + operator_id + " " + select_date, 'User name - ' + operator_name, closeIframeCallback, '', '', true);
      };
      ...
      $scope.onExportUserwise = function () {
        ...
        sparrow.downloadData("/pws/user_efficiency_user_reports_export/", {
      ...
      $scope.onExportShiftWise = function () {
        ...
        var postData = $scope.postData;
        sparrow.downloadData("/pws/user_efficiency_shift_reports_export/", {
          start: $rootScope.start,
          length: $rootScope.length,
          today_date_: postData["today_date_"],
          order_by: order_by_,
      ...
      $scope.onExportCustomerWise = function () {
        ...
        var postData = $scope.postData;
        sparrow.downloadData("/pws/user_efficiency_customer_reports_export/", {
          start: $rootScope.start,
          length: $rootScope.length,
          today_date_: postData["today_date_"],
          order_by: order_by_,
