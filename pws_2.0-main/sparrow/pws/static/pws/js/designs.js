  ...
  sparrow.registerCtrl(
    ...
    function (
      ...
      $scope.allPageTitles = {
        ...
        gerber_release: "Design (Gerber release)",
      };
        ...
        listing: [
          {
            ...
            search: searchObj,
            url:
              "/pws/workspace_search/schematic/0/" +
              $scope.requestStatus["schematic"] +
              "/",
            crud: true,
            scrollBody: true,
            columns: columnObj,
          },
          {
            ...
            search: searchObj,
            url:
              "/pws/workspace_search/footprint/0/" +
              $scope.requestStatus["footprint"] +
              "/",
            crud: true,
            scrollBody: true,
            columns: columnObj,
          },
          {
            ...
            search: searchObj,
            url:
              "/pws/workspace_search/placement/0/" +
              $scope.requestStatus["placement"] +
              "/",
            crud: true,
            scrollBody: true,
            columns: columnObj,
          },
          {
            ...
            search: searchObj,
            url:
              "/pws/workspace_search/routing/0/" +
              $scope.requestStatus["routing"] +
              "/",
            crud: true,
            scrollBody: true,
            columns: columnObj,
          },
          {
            ...
            search: searchObj,
            url:
              "/pws/workspace_search/gerber_release/0/" +
              $scope.requestStatus["gerber_release"] +
              "/",
            crud: true,
            scrollBody: true,
            columns: columnObj,
      ...
      function onExport() {
        if (data.permissions["can_export_job_processing_design"] == false) {
      ...
      $scope.onTabChange = function (status, index) {
        ...
        history.replaceState(
          undefined,
          undefined,
          "#/job_processing/design/?state=" + status
        );
        ...
        if ($scope.requestStatus[status] == false) {
          config.listing[index - 1].url =
            "/pws/workspace_search/" + status + "/0/true/";
      ...
      function OnReserve() {
        $scope.ReserveorderList = [];
        if (data.permissions['reserve_order_design'] == false) {
            sparrow.showMessage('appMsg', sparrow.MsgType.Error, 'You do not have permission to perform this action', 3);
            return;
        }
      ...
      function OnRelease() {
        if (data.permissions['release_order_design'] == false) {
            sparrow.showMessage('appMsg', sparrow.MsgType.Error, 'You do not have permission to perform this action', 3);
            return;
        }
        var selectedId = $scope.getSelectedIds($scope.tabIndex);
      ...
      function onSendtonext() {
        if (data.permissions['send_to_next_design'] == false) {
          sparrow.showMessage('appMsg', sparrow.MsgType.Error, 'You do not have permission to perform this action', 3);
          return;
        };
      ...
      function showGenerateException(scope) {
          ...
          if (data.permissions['generate_exception_design'] == false) {
                sparrow.showMessage('appMsg', sparrow.MsgType.Error, 'You do not have permission to perform this action', 3);
                return;
            }
          else{
      ...
      function onFileSearch() {
        if (data.permissions['view_file_design'] == false) {
            sparrow.showMessage('appMsg', sparrow.MsgType.Error, 'You do not have permission to perform this action', 3);
            return;
        }
